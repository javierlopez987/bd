...
ALTER TABLE GR05_DISTRITO ADD CONSTRAINT FK_GR05_DISTRITO_PROVINCIA
...
ALTER TABLE GR05_EVENTO ADD CONSTRAINT FK_GR05_EVENTO_DISTRITO
...
ALTER TABLE GR05_EVENTO_EDICION ADD CONSTRAINT FK_GR05_EVENTO_EDICION_EVENTO
...
ALTER TABLE GR05_EVENTO ADD CONSTRAINT FK_GR05_EVENTO_SUBCATEGORIA
...
ALTER TABLE GR05_EVENTO ADD CONSTRAINT FK_GR05_EVENTO_USUARIO
...
ALTER TABLE GR05_PATROCINIOS ADD CONSTRAINT FK_GR05_PATROCIONIOS_EVENTO_EDICION
...
ALTER TABLE GR05_PATROCINIOS ADD CONSTRAINT FK_GR05_PATROCIONIOS_PATROCINANTE
...
ALTER TABLE GR05_PROVINCIA ADD CONSTRAINT FK_GR05_PROVINCIA_PAIS
...
ALTER TABLE GR05_SUBCATEGORIA ADD CONSTRAINT FK_GR05_SUBCATEGORIA_CATEGORIA
...
ALTER TABLE GR05_PATROCINANTE ADD CONSTRAINT FK_GR05_PATROCINANTE_DISTRITO
    FOREIGN KEY (id_distrito)
    REFERENCES GR05_DISTRITO (id_distrito)
    NOT DEFERRABLE
    INITIALLY IMMEDIATE
